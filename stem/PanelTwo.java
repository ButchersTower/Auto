...
public class PaneltTwo extends JPanel implements Runnable, KeyListener,
		MouseListener {
	...
	// String[][] bigTree = { { "Noun" }, { "Verb", "To be" }, { "Noun" },
	// { "Verb" }, { "To be" }, { "Adjective" }, { "Adjective" },
	// { "Adjective" }, { "Adjective" }, { "Noun" }, { "Preposition" },
	// { "Noun" } };

	// int[][][] treeGoesTo = { { { 1 } }, { { 2, 3 }, { 4 } }, { { 5 } },
	// { { 6 }, { 7 } }, { { -1 } }, { { -1 } }, { { 8 } }, { { -1 } },
	// { { 9 } }, { { 10 } }, { { -1 } } };
	String[][] bigTree = { { "Noun" }, { "Verb", "To be" }, { "Noun" },
			{ "Verb", "To be" }, { "Adjective" }, { "Adjective" },
	...
	// String[][] bigTree = { { "Noun" }, {"Pronoun"},{ "Verb", "To be" }, {
	// "Noun" }, { "Verb" }, { "To be" }, { "Adjective" }, { "Adjective" }, {
	// "Adjective" }, { "Adjective" }, { "Noun" }, { "Preposition" }, { "Noun" }
	// };

	// int[][][] treeGoesTo = { { { 2 } }, { { 2 } }, { { 3, 4 }, { 5 } },
	// { { 6 } }, { { 7 }, { 8 } }, { { -1 } }, { { -1 } }, { { 9 } },
	// { { -1 } }, { { 10 } }, { { 11 } }, { { -1 } } };
		...
		loopa: for (int i = 0; i < nums.length; i++) {
			...
			loopp: for (int p = 0; p < possableNext.length; p++) {
				if (possableNext[p] != -1) {
					...
					// pronoun. This is only for the first because i dont know
					// how to make it work for either, WAIT.
					if (bigTree[possableNext[p]][0].equals("Noun")) {
						if (words.get(nums[i])[1].equals("Noun")
								|| words.get(nums[i])[1].equals("Pronoun")) {

						}
					}
					System.out.println("word: " + words.get(nums[i])[1]
							+ "     tree: " + bigTree[possableNext[p]][0]
							+ "    word: " + words.get(nums[i])[0]);
